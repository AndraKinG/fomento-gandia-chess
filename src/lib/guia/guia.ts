...
export const GUIA: readonly SeccionGuia[] = [
  ...
  },
  {
    ...
    titulo: "Torneos",
    rango: "jugador",
    que: "Dos pestañas: los de fuera (calendario FACV) y los del club.",
    puntos: [
      "En los de fuera: decir si vas y cuadrar coches",
      "En los del club: inscribirte, ver rondas y clasificación",
      "Las partidas de torneo del club se juegan aquí, en la app",
      "Ranking de ELO del club, que sale solo de estos torneos",
    ],
  },
  {
    clave: "jugar",
